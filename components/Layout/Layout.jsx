          ...
          <li className="flex flex-col">
              ...
              {openMenu.content && (
                <ul className="ml-12 mt-2 border-l-2 border-gray-2  space-y-2">
                  <li className={`${HandleFunction('/content/home-page') ? "bg-[#F6F6FF] text-[#434CE7]":"text-[#0A1215]"} cursor-pointer hover:text-[#434CE7] hover:bg-[#F6F6FF] relative px-4 py-2 rounded-[10px]   ml-3`}>
                    <Link href="/content/home-page" onClick={handleAside} className='flex font-medium w-[100%]'>Homepage</Link>
                    {HandleFunction('/content/home-page') && <div className='w-[2px] absolute top-0.5 -left-[14px] h-[35px] bg-[#434CE7]'></div>}
                  </li>
                  <li className={`${HandleFunction('/content/site-page') ? "bg-[#F6F6FF] text-[#434CE7]":"text-[#0A1215]"} cursor-pointer hover:text-[#434CE7] hover:bg-[#F6F6FF] relative px-4 py-2 rounded-[10px]   ml-3`}>
                     <Link href="/content/site-page" onClick={handleAside} className='flex font-medium w-[100%]'>Site Pages</Link>
                     {HandleFunction('/content/site-page') && <div className='w-[2px] absolute top-0.5 -left-[14px] h-[35px] bg-[#434CE7]'></div>}
                  </li>
                  <li className={`${HandleFunction('/content/policies') ? "bg-[#F6F6FF] text-[#434CE7]":"text-[#0A1215]"} cursor-pointer hover:text-[#434CE7] hover:bg-[#F6F6FF] relative px-4 py-2 rounded-[10px]   ml-3`}>
                  <Link href="/content/policies" onClick={handleAside} className='flex font-medium w-[100%]'>Policies</Link>
                     {HandleFunction('/content/policies') && <div className='w-[2px] absolute top-0.5 -left-[14px] h-[35px] bg-[#434CE7]'></div>}
                  </li>
                  <li className={`${HandleFunction('/content/guides') ? "bg-[#F6F6FF] text-[#434CE7]":"text-[#0A1215]"} cursor-pointer hover:text-[#434CE7] hover:bg-[#F6F6FF] relative px-4 py-2 rounded-[10px]   ml-3`}>
                  <Link href="/content/guides" onClick={handleAside} className='flex font-medium w-[100%]'>Guides</Link>
                     {HandleFunction('/content/guides') && <div className='w-[2px] absolute top-0.5 -left-[14px] h-[35px] bg-[#434CE7]'></div>}
                  </li>
                  <li className={`${HandleFunction('/content/birth-stones') ? "bg-[#F6F6FF] text-[#434CE7]":"text-[#0A1215]"} cursor-pointer hover:text-[#434CE7] hover:bg-[#F6F6FF] relative px-4 py-2 rounded-[10px]   ml-3`}>
                  <Link href="/content/birth-stones" onClick={handleAside} className='flex font-medium w-[100%]'>Birthstones</Link>
                     {HandleFunction('/content/birth-stones')  && <div className='w-[2px] absolute top-0.5 -left-[14px] h-[35px] bg-[#434CE7]'></div>}
                  </li>
                  <li className={`${HandleFunction('/content/social-medias') ? "bg-[#F6F6FF] text-[#434CE7]":"text-[#0A1215]"} cursor-pointer hover:text-[#434CE7] hover:bg-[#F6F6FF] relative px-4 py-2 rounded-[10px]   ml-3`}>
            ...
            <li className={`flex ${HandleFunction('/reviews-and-ratings') ? "bg-[#F6F6FF]":""} hover:bg-[#F6F6FF] cursor-pointer px-4 py-3 rounded-[10px] items-center gap-3`}>
            <Link href="/reviews-and-ratings" onClick={handleAside} className='flex gap-3 items-center w-[100%]'>
            ...
            <li className={`flex ${HandleFunction('/custom-jewelry') ? "bg-[#F6F6FF]":""} hover:bg-[#F6F6FF] cursor-pointer px-4 py-3 rounded-[10px] items-center gap-3`}>
            <Link href="/custom-jewelry" onClick={handleAside} className='flex gap-3 items-center w-[100%]'>
              <FaGem className='text-[#82838A]' />
              <span className='text-[#0A1215]'>Custom Jewelry</span>
            </Link>
            </li>
            <li className={`flex ${HandleFunction('/footer') ? "bg-[#F6F6FF]":""} hover:bg-[#F6F6FF] cursor-pinter px-4 py-3 rounded-[10px] items-center gap-3`}>
            <Link href="/footer" onClick={handleAside} className='flex gap-3 items-center w-[100%]'>
        ...
        <div className="fixed bottom-0 left-0 right-auto bg-white w-[300px] p-5 border-t-[#EAECF0]  border-t-2  flex items-center justify-between">
          <div className="flex items-center gap-3">
             <div className='w-[40px] h-[40px] rounded-full'>
               <img src="/images/avator.png" className='w-[40px] h-[40px] rounded-full' alt="" />
             </div>
            <div>
  ...
  return (
    <div className="relative  w-[100%]  lg:left-0 lg:top-0  lg:h-[100vh] bg-gray-200 lg:shadow-lg ">
      ...
      <div className='flex items-center gap-3 p-y justify-start'>
            <div className='h-[40px] w-[40px] rounded-full'>
              <img src="/favicon.svg" alt="" className='object-cover w-[100%] h-[100%]' />
            </div>
            <div className='flex items-start justify-start flex-col '>
