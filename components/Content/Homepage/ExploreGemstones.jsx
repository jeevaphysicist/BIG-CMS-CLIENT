...
import exploreGem from "../../../assets/image 6.png";
import { FiSave } from "react-icons/fi";
import RequiredSymbol from "../RequiredSymbol";

const ExploreGemstones = ({ handleHomepage }) => {
  return (
    <Fragment>
        ...
        <div className="w-full h-full md:flex md:flex-row-reverse gap-6">
          ...
          <div className="md:w-[40%] h-full pt-10">
            <div className="rounded-[12px] border-2 p-2 md:p-4 flex items-center gap-4 sticky">
              ...
              <div>
                <img src={'/images/image 6.png'} alt="content" />
              </div>
            </div>
          </div>
          {/* Form */}
            ...
            <div className="w-full flex flex-col gap-8">
              <div className="flex flex-col gap-3">
                ...
                <Input
                  type="text"
                  id="sec_title"
                  placeholder="Explore Gemstones Collection"
                  variant="bordered"
                  size="lg"
                  radius="sm"
                />
              ...
              <div className="flex flex-col gap-3">
                ...
                <Input
                  type="text"
                  id="explore_desc"
                  placeholder="Our recent additions in the Gemstones"
                  variant="bordered"
                  size="lg"
                  radius="sm"
                />
              ...
              <div className="flex flex-col gap-3">
                ...
                <Input
                  type="text"
                  id="action_desc"
                  placeholder="Explore All Gemstones"
                  variant="bordered"
                  size="lg"
                  radius="sm"
                />
