    ...
    <Fragment>
      {homePage ? (
        <div className=" p-5 no-scrollbar">
          ...
          <TableBody>
            <TableRow key="1">
              <TableCell><p className="text-nowrap">Home</p></TableCell>
              <TableCell><p className="text-balance w-[200px]">Exhibiting a mesmerizing blend of amethyst and citrine colors..</p></TableCell>
              <TableCell>
                {
                isChecked ?
