...
const Faqs = ({ handleGuide, type, title, sectionData, fetchData }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (type === "create") {
        response = await handleCreateGuide(formData, false);
      } else if (type === "edit") {
        response = await handleUpdateGuide(formData, sectionData._id, false);
      }
