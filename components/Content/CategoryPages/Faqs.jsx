...
import { handleUpdateCategorySubCategory, handleUpdateCustomJewelry } from "@/API/api";

const Faqs = ({  handleCategoryPage, sectionData, fetchData }) => {
  ...
  useEffect(() => {
    if (sectionData) {
      ...
      setQuestions(
        sectionData.faqs?.questions || [{ question: "", answer: "" }]
      );
    }
  }, [sectionData]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      let response = await handleUpdateCategorySubCategory(        
        sectionData._id,
        bodyData,
        false
      );
